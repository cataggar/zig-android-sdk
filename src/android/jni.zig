...
pub const JNINativeInterface = extern struct {
    ...
    NewObject: ?*anyopaque,
    NewObjectV: ?*const fn(*JNIEnv, jclass, jmethodID, std.builtin.VaList) callconv(.c) jobject,
    ...
    CallNonvirtualBooleanMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jboolean,
    ...
    CallNonvirtualByteMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jbyte,
    ...
    CallNonvirtualCharMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jchar,
    ...
    CallNonvirtualShortMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jshort,
    ...
    CallNonvirtualIntMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jint,
    ...
    CallNonvirtualLongMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jlong,
    ...
    CallNonvirtualFloatMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jfloat,
    ...
    CallNonvirtualDoubleMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) jdouble,
    ...
    CallNonvirtualVoidMethodV: ?*const fn(*JNIEnv, jobject, jclass, jmethodID, std.builtin.VaList) callconv(.c) void,
    ...
    CallStaticObjectMethodV: ?*const fn(*JNIEnv, jclass, jmethodID, std.builtin.VaList) callconv(.c) jobject,
    ...
    CallStaticBooleanMethodV: ?*const fn(*JNIEnv, jclass, jmethodID, std.builtin.VaList) callconv(.c) jboolean,
